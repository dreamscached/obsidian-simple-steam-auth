...
Version releases are generated by GitHub Actions,
[attested](https://docs.github.com/en/actions/how-tos/secure-your-work/use-artifact-attestations/use-artifact-attestations),
and verifiable against the source commit.
...
[patched](.yarn/patches/steam-totp-npm-2.1.2-aaff39ad0a.patch) with *minimal* changes, solely to port Node-specific
logic to the Obsidian browser JS environment.
